...
{
	return *randomizer = *randomizer * CCR_MULTIPLY_32 + CCR_ADD_32;
}

uint64_t ccrGenerateUint64(ccRandomizer64 *randomizer)
{
	return *randomizer = *randomizer * CCR_MULTIPLY_64 + CCR_ADD_64;
}

float ccrGenerateFloat32(ccRandomizer32 *randomizer)
{
	return (float)(*randomizer = *randomizer * CCR_MULTIPLY_32 + CCR_ADD_32) / UINT32_MAX;
}

float ccrGenerateFloat64(ccRandomizer64 *randomizer)
{
	return (float)(*randomizer = *randomizer * CCR_MULTIPLY_64 + CCR_ADD_64) / UINT64_MAX;
}

double ccrGenerateDouble32(ccRandomizer32 *randomizer)
{
	return (double)(*randomizer = *randomizer * CCR_MULTIPLY_32 + CCR_ADD_32) / UINT32_MAX;
}

double ccrGenerateDouble64(ccRandomizer64 *randomizer)
{
	return (double)(*randomizer = *randomizer * CCR_MULTIPLY_64 + CCR_ADD_64) / UINT64_MAX;
}